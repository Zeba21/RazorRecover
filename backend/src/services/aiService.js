...
/**
 * Service helper to run Module 6 LangGraph AI Recovery Agent from FastAPI AI Service.
 */
async function runRecoveryAgent(payload) {
  const url = `${config.aiServiceUrl}/run-recovery-agent`;
